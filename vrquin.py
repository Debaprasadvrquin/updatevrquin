...
shutil.copy(src_path, dst_path)
os.remove("/home/pi/brand_pisignage_portrait.mp4")
src_path = directory + "/brand_pisignage_portrait.mp4"
dst_path = r"/home/pi/brand_pisignage_portrait.mp4"
shutil.copy(src_path, dst_path)
